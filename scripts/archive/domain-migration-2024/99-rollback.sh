...
echo "     pnpm run cdk -- deploy Prance-dev-Dns --require-approval never"
echo "     pnpm run cdk -- deploy Prance-dev-Certificate --require-approval never --region us-east-1"
echo "     pnpm run cdk -- deploy Prance-dev-Storage --require-approval never"
echo "     pnpm run cdk -- deploy Prance-dev-ApiLambda --require-approval never"
echo "     pnpm run cdk -- deploy Prance-dev-Cognito --require-approval never"
echo ""
